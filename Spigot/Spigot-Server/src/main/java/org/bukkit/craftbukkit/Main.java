        ...
        OptionParser parser = new OptionParser() {
            {
                ...
                acceptsAll(asList("M", "Maps"), "Maps directory to use for Zengames")
                        .withRequiredArg()
                        .ofType(File.class)
                        .defaultsTo(new File("Maps"))
                        .describedAs("Maps directory");
                
                
            }
        };

        //check if folders Maps exist
		String directoryPath = "Maps";
		File file = new File(directoryPath);

		if (!file.isDirectory()) {
			
            System.out.println("Loading zengames maps, please wait...");
            file.mkdir();
    		String directoryPathOctogone = "Maps/Octogone";
    		File fileOctogone = new File(directoryPathOctogone);
    		fileOctogone.mkdir();
    		String directoryPathUhc = "Maps/Uhc";
    		File fileUhc = new File(directoryPathUhc);
    		fileUhc.mkdir();
