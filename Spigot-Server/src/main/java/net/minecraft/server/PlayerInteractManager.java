...
public class PlayerInteractManager {
    ...
    public boolean breakBlock(BlockPosition blockposition) {
        ...
        if (this.player instanceof EntityPlayer) {
            ...
            event.setBlockDrops(block.getDrops());
        ...
        if (false && this.gamemode.d() && this.player.bA() != null && this.player.bA().getItem() instanceof ItemSword) {
            ...
            if (this.isCreative()) {
                ...
                if (flag && flag1) {
                	...
                	iblockdata.getBlock().dropsItems(this.world, this.player, blockposition, iblockdata, tileentity, event.getBlockDrops(), event.isDropOnFeet(), event.getBlockDrops().equals(event.getBlock().getDrops()));
...
//                    iblockdata.getBlock().a(this.world, this.player, blockposition, iblockdata, tileentity);
            ...
            if (flag && event != null) {
            	if (event.isDropOnFeet())
            		iblockdata.getBlock().dropExperience(this.world, new BlockPosition(this.player.locX, this.player.locY, this.player.locZ), event.getExpToDrop());
            	else
